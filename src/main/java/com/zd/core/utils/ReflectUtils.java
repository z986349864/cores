...
public class ReflectUtils {
     ...
     * @return
     */
    public static <T> boolean isEmpty(T bean, String... ignoreFields) {
        return isNoneFieldInit(bean, false, ignoreFields);
    }
     ...
     * @return
     */
    public static <T> boolean isBlank(T bean, String... ignoreFields) {
        return isNoneFieldInit(bean, true, ignoreFields);
    }
     ...
     * @return
     */
    public static <T> boolean isNoneFieldInit(T bean, boolean blank, String... ignoreFields) {
        List<String> ignoreFieldList = Arrays.asList(ignoreFields);
        return isNoneFieldInit(bean, blank, ignoreFieldList);
    }
     ...
     * @return
     */
    public static <T> boolean isEmpty(T bean, List<String> ignoreFieldList) {
        return isNoneFieldInit(bean, false, ignoreFieldList);
    }
     ...
     * @return
     */
    public static <T> boolean isBlank(T bean, List<String> ignoreFieldList) {
        return isNoneFieldInit(bean, true, ignoreFieldList);
    }
     ...
     * @return
     */
    public static <T> boolean isNoneFieldInit(T bean, boolean blank, List<String> ignoreFieldList) {
        List<Field> fieldList = getAllFieldsThenSetAccessible(bean.getClass());
        boolean flag = true;
        for (Field field : fieldList) {
            if (Modifier.isStatic(field.getModifiers()) || ignoreFieldList.contains(field.getName())) {
                continue;
            }
     ...
     * @return
     */
    public static <T, F> F getFieldValIgnoreException(T t, String fieldName) {
